...
function showOptionsMenu(button) {
  ...
  var elementOffset = $(button).offset().top; // Get distance from button to top of document.

  var top = elementOffset - scrollTop; // Difference between top of document and button position.
  var left = $(button).position().left; // Position of button from left of document.
